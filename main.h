...
int _putchar_buffer(buffer_tbuffer, char c);
void flush_buffer(buffer_t buffer);
int pString(charstring, buffer_t buffer);
int print_num(int n, buffer_tbuffer);
int print_unsigned(unsigned int n, buffer_t buffer);
int print_binary(unsigned int n, buffer_tbuffer);
int print_octal(unsigned int n, buffer_t buffer);
int print_hex_lower(unsigned int n, buffer_tbuffer);
int print_hex_upper(unsigned int n, buffer_t buffer);
int print_string_custom(charstring, buffer_t *buffer);
